...
@Composable
fun ResumoDeputadosScreen(
    viewModel: ResumoDeputadoViewModel = koinViewModel(),
    onResumoClick: (ResumoDeputado) -> Unit) {
            ...
            state.error != null -> {
                ...
                LazyColumn(
                    ...
                    items(state.resumos) { resumo ->
                        ResumoDeputadoItem(resumo){
                            onResumoClick(resumo)
                        }
                    }
                }
            }
